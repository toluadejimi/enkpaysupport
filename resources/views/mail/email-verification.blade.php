                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        {!! getEmailTemplate($template, 'body', $link, '', $userData) !!}
                                        <br>

                                        <a href="{{ $link }}"
                                            style="background:#6659FF;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px; display:inline-block; border-radius:50px;">{{ __('Verify Your Email') }}</a>
                        ...
                        <td style="text-align:center;">
                            @if (getGeneralSetting('app_copyright') != null)
                                <p
                                    ...
                                    <strong>{{ getGeneralSetting('app_copyright') }}</strong>
                                </p>
                            @endif
                        </td>
                    </tr>
