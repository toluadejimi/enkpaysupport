                    ...
                    <div class="profile-info">
                                ...
                                <div class="set-password">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link mr-1 user-btu active mb-3" id="pills-home-tab"
                                                    data-bs-toggle="pill"
                                                    data-bs-target="#pills-home-tb" type="button" role="tab"
                                                    aria-controls="pills-home"
                                                    aria-selected="true">{{__("Profile Information")}}
                                            </button>
                                        </li>
                                        <li class="nav-item " role="presentation">
                                            <button class="nav-link user-btu mb-3" id="pills-profile-tab"
                                                    data-bs-toggle="pill"
                                                    data-bs-target="#pills-profile-tb" type="button" role="tab"
                        ...
                        <div class="row">
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home-tb" role="tabpanel"
                                            ...
                                            <form action="{{route('customer.profile.update')}}" method="post"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="upload-profile-photo-box ">
                                                        <div class="img-area">
                                                            <div class="profileImgpart sf-max-w-100">
                                                                <img id="blah"
                                                    ...
                                                    <div class="col-md-5 mb-25">
                                                        <div class="user-info-from">
                                                            <label class="label-text-title">{{__("Email address")}}
                                                                <span>*</span></label>
                                                            <input type="text" class="formControl" disabled
                                ...
                                <div class="tab-pane fade" id="pills-profile-tb" role="tabpanel"
