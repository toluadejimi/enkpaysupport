            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-horizontal__item bg-style">
                        ...
                        <form class="ajax reset" action="{{route('admin.setting.role.store')}}" method="post"  data-handler="commonResponseForModal">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 text-right">
                                    <input type="submit" class="btn btn-blue  m-lg-2" value="{{__('Save')}}" name="save">
                                </div>
                            </div>
                        </form>
                    </div>
