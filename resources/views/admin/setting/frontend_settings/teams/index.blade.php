...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <input type="hidden" id="news-list-route" value="{{ route('admin.setting.frontend.team.index') }}">
    ...
    <div class="modal fade" id="add-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="ajax reset" action="{{ route('admin.setting.frontend.team.store') }}" method="post"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="input__group mb-25">
                                    <label for="description">{{ __('Facebook Link') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" name="facebook_link" rows="5" id=""></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input__group mb-25">
                                    <label for="description">{{ __('Instagram Link') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" name="instagram_link" rows="5" id=""></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input__group mb-25">
                                    <label for="description">{{ __('Twitter Link') }} <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" name="twitter_link" rows="5" id=""></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input__group mb-25">
...
@push('script')
    ...
    <script src="{{ asset('admin/js/custom/team.js') }}"></script>
