...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <input type="hidden" id="news-list-route" value="{{ route('admin.setting.frontend.faq-category.index') }}">
            ...
            <div class="modal fade" id="add-modal" aria-hidden="true" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="ajax reset" action="{{ route('admin.setting.frontend.faq-category.store') }}" method="post"
...
@push('script')
    ...
    <script src="{{ asset('admin/js/custom/faqCategoryDataTable.js') }}"></script>
@endpush
