<div class="email-inbox__area bg-style">
    ...
    <form class="ajax" action="{{route('admin.setting.settings_env.update')}}" method="post"
        ...
        <div class="form-group text-black row mb-3">
            <label class="col-lg-3">{{ __('Chanel Name') }} </label>
            <div class="col-lg-9">
                <input type="text" name="pusher_chanel_name"
                       id="pusher_chanel_name"
                       value="{{getOption('pusher_chanel_name')}}" class="form-control">
            </div>
        </div>
