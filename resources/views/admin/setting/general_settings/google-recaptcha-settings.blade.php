                            ...
                            <div class="form-group text-black row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <select name="google_recaptcha_status" id="google_recaptcha_status"
                                        ...
                                        <option value="1"
                                                @if(getOption('google_recaptcha_status') == STATUS_ACTIVE) selected @endif>{{ getStatus(STATUS_ACTIVE) }}</option>
                                        <option value="0"
                                                @if(getOption('google_recaptcha_status') != STATUS_ACTIVE) selected @endif>{{ getStatus(STATUS_DISABLE) }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
