                ...
                <div class="col-md-12">
                    <div class="breadcrumb-text-bg">
                        ...
                        <div class="breadcrumb-items">
                            ...
                            <li>/</li>
                            <li><a class="active" href="">{{__("Contact Us")}}</a></li>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="contact-input mb-5 pb-3">
                                        ...
                                        <input value="{{old('name')}}" type="text" class="form-control mb-0" id="name" name="name"
                                ...
                                <div class="col-md-6">
                                    <div class="contact-input mb-5 pb-3">
                                        ...
                                        <input value="{{old('email')}}" type="email" class="form-control mb-0" id="email" name="email"
                                ...
                                <div class="col-md-6">
                                    <div class="contact-input mb-5 pb-3">
                                        ...
                                        <input value="{{old('phone')}}" type="text" class="form-control mb-0" id="phone" name="phone"
                                ...
                                <div class="col-md-6">
                                    <div class="contact-input mb-5 pb-3">
                                        ...
                                        <input value="{{old('control')}}" type="text" class="form-control mb-0" id="subject" name="subject"
                                ...
                                <div class="col-md-12">
                                    <div class="contact-input">
                                        ...
                                        <textarea  value="{{old('message')}}" class="form-control message-box mb-0" name="message" id="message" cols="30"
                ...
                <div class="col-lg-4">
                    <div class="contact-icon">
                        ...
                        <div class="single icon-contact">
                            ...
                            @else
                                <p>{{__('No Contact Number Found')}}</p>
                            @endif
                        </div>
                        <div class="single icon-contact">
                            <div>
