...
<meta property="og:image" content="{{getFileUrl(getGeneralSettingData(getUserIdByTenant(),'app_fav_icon'))}}">
...
<meta name="twitter:image" content="{{getFileUrl(getGeneralSettingData(getUserIdByTenant(),'app_fav_icon'))}}">
