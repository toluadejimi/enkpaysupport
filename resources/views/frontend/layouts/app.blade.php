...
@if(getOption('app_preloader_status') == STATUS_ACTIVE)
    <!-- Pre Loader Area start -->
    <div id="preloader">
        <div id="preloader_status"><img src="{{getFileUrl(getGeneralSettingData(getUserIdByTenant(),'app_preloader'))}}" alt="{{ getOption('app_name') }}"/>
        </div>
    </div>
    <!-- Pre Loader Area End -->
@endif
