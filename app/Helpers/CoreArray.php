...
if(!function_exists("getRoleName")){
    function getRoleName($input = null)
    {
        $output = [
            ...
            USER_ROLE_AGENT => __('Agent'),
            USER_ROLE_CUSTOMER=> __('Customer'),
        ];
...
{
    $output = array(
        PAYPAL => 'App\Http\Services\Saas\Payment\PaypalService',
        STRIPE => 'App\Http\Services\Saas\Payment\StripeService',
        RAZORPAY => 'App\Http\Services\Saas\Payment\RazorpayService',
        INSTAMOJO => 'App\Http\Services\Saas\Payment\InstamojoService',
...
if(!function_exists("getTicketStatus")){
    function getTicketStatus($input = null)
    {
        $output = [
            STATUS_OPEND => 'New',
...
if(!function_exists("getPriorityStatus")){
    function getPriorityStatus($input = null)
    {
        $output = [
            LOW => 'Low',
            MEDIUM => 'Medium',
...
if(!function_exists("getPriorityColor")){
    function getPriorityColor($input = null)
    {
        $output = [
            LOW => 'low',
            MEDIUM => 'medium',
