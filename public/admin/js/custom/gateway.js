(function ($) {
    ...
    window.getDataEditRes = getDataEditRes;
        ...
        if (response.data.gateway.slug == 'bank') {
            ...
            if (banks.length > 0) {
                Object.entries(banks).map(function (bank) {
                    ...
                    bankHtml += `<div class="multi-bank bg-white radius-4 theme-border p-3 mb-25">
                                <div class="row">
                                    <div class="col-6 mb-20">
                                        ...
                                        <input type="text" name="bank[name][]" class="form-control bank-name" id="name" placeholder="{{__("Bank Name")}}" value="${bank[1].name}">
                                    </div>
                                    <div class="col-6 mb-20">
...
// Bank
    ...
    function addBank() {
        return `<div class="multi-bank bg-white radius-4 theme-border p-3 mb-25">
                <div class="row">
                    <div class="col-6 mb-20">
                        <input type="hidden" name="bank[id][]" value="">
                        <label for="name" class="label-text-title color-heading font-medium mb-2">Bank Name</label>
                    ...
                    <div class="row mb-20">
                        <div class="col-12 text-end"><button type="button" class="bg-danger text-white p-1 rounded-2 remove-bank" title="Remove">Remove</button></div>
                    </div>
                </div>
            </div>`;
    }

    window.responseOnGatewaStore = responseOnGatewaStore;
    function responseOnGatewaStore(response) {
        var output = '';
        var type = 'error';
